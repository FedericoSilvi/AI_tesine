...
def main_phase_1(feature_selection : bool = False, filepath : str ="DARWIN.csv", mlp : MLPClassifier = None):
    ...
    - Addestramento e mini report su cross validation
    - Addestramento e mini repor con train/test split
...
def main_phase_2(mlp_configs : Dict, feature_selection : bool = False, filepath : str ="DARWIN.csv",):
    ...
    Nell'ordine compie:
    - Caricamento dataset
    - Addestramento tramite cross-validation degli MLP passati
    - Accumulazione dei risultati in dizionari appositi
    """
