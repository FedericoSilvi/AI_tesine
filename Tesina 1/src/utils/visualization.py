...
class NetworkVisualizer:
    ...
    SCENARIO_CONFIGS = {
        'smartcity': {
            'title': 'Smart City IoT Scenario - Urban Network Optimization',
            'path_color': 'purple',
            'description': (
                'Objective: Optimize IoT network in smart city\n'
                'Constraints:\n'
                '- Minimize latency\n'
                '- Prioritize high-priority sensors\n'
                '- Ensure bandwidth requirements'
            ),
            'legend_items': [
                ('lightblue', 'Low Priority Node (Smart Lights)'),
                ('orange', 'Medium Priority Node (Environmental)'),
                ('red', 'High Priority Node (Traffic Sensors)')
            ]
        },
        'seismic': {
